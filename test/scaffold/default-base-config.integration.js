...
describe('#defaultBaseConfig', function() {
  it('will return expected configuration', function() {
    ...
    protocolxd.spawn.datadir.should.equal(home + '/.protocolx');
    protocolxd.spawn.exec.should.equal(path.resolve(__dirname, '../../bin/protocolxd'));
  });
  ...
  it('be able to specify a datadir', function() {
    ...
    info.config.servicesConfig.protocolxd.spawn.datadir.should.equal('./data2');
  });
});
