...
describe('Node Functionality', function() {
    ...
    rimraf(datadir + '/regtest', function(err) {
      ...
      node.start(function(err) {
        ...
        var syncedHandler = function() {
          if (node.services.protocolxd.height === 150) {
            node.services.protocolxd.removeListener('synced', syncedHandler);
            done();
          }
        };

        node.services.protocolxd.on('synced', syncedHandler);
  ...
  describe('Bus Functionality', function() {
    it('subscribes and unsubscribes to an event on the bus', function(done) {
      ...
      bus.on('protocolxd/hashblock', function(data) {
        bus.unsubscribe('protocolxd/hashblock');
        if (blockExpected) {
  ...
  describe('Address Functionality', function() {
    ...
    before(function(done) {
      ...
      var startHeight = node.services.protocolxd.height;
      node.services.protocolxd.on('tip', function(height) {
    ...
    describe('Mempool Index', function() {
      ...
      it('will update the mempool index after new tx', function(done) {
        ...
        node.services.protocolxd.sendTransaction(tx.serialize(), function(err, hash) {
