...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `protocolxcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ protocolxcore-node add wallet-service');
      console.log('    $ protocolxcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ protocolxcore-node remove wallet-service');
      console.log('    $ protocolxcore-node remove insight-api');
      console.log();
    });
